...
let secondsToMilliseconds = (seconds: int): float => seconds->Belt.Int.toFloat *. 1000.0
...
let daysToMilliseconds = (days: int): float => days->Belt.Int.toFloat *. hoursToMilliseconds(24)
...
let format = (self: t): string => {
  ...
  if hours > 0 {
    ...
    formattedTime.contents =
      formattedTime.contents ++ `${prefix}${hours->Belt.Int.toString} hour${suffix}`
  }
  ...
  if minutes > 0 {
    ...
    formattedTime.contents =
      formattedTime.contents ++ `${prefix}${minutes->Belt.Int.toString} minute${suffix}`
  }
  ...
  if seconds > 0 {
    ...
    formattedTime.contents =
      formattedTime.contents ++ `${prefix}${seconds->Belt.Int.toString} second${suffix}`
  }
